<template>
    <div class="row">
        <div class="col-lg-12" >
                ...
                <div class="ibox-content">
                    ...
                    <div class="table-responsive" style="margin-top: 15px;" v-if="!isLoading">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            <tr v-for="(value,index) in brands.data" :key="index">
                                <td><img v-lazy="value.image" style="max-height: 100px;"></td>
                                <td>{{ value.brand_name }}</td>
                                <td>{{ value.brand_native_name }}</td>
                                <td>{{ value.status_text }}</td>
                                <td>
                                    <a @click.prevent="edit(value.id)" class="btn btn-primary" href="#"><i class="fa fa-edit" title="Edit"></i></a> 
                                    <a @click.prevent="deletebrand(value.id)" class="btn btn-danger" href="#"><i class="fa fa-trash" title="Delete"></i></a>
                                </td>
                            </tr>
            ...
            <div class="ibox animated fadeInRightBig">
               <pagination v-if="brands.meta" :pageData="brands.meta"></pagination> 
            </div>
...
<script>
    ...
    import UpdateBrand from './EditBrand';
	...
	export default {
       ...
       mounted(){
        ...
        EventBus.$on('brand-created',function(){
       ...
       methods : {
        ...
        getbrand(page = 1){
         ...
         axios.get(base_url+'admin/brand-list?page='+page+'&keyword='+this.keyword)
              .then(response => {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                axios.get(base_url+'admin/brand/delete/'+id)
                .then(res => {
