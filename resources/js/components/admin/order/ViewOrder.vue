            ...
            <div class="ibox-content">
                <div class="row">
                    ...
                    <div class="col-md-2 m-b-xs">
                        <div class="input-group">
                     <select class="form-control" @change="getOrder()"  v-model="status" >
                    ...
                    <div class="input-group">
                            <select class="form-control" @change="getOrder()" v-model="payment_status" >
                ...
                <div class="table-responsive" style="margin-top: 15px;" v-if="!isLoading">
                    <table class="table table-bordered">
                        ...
                        <tr v-for="(value,index) in orders.data" :key="index">
                            ...
                            <td>{{ currency.symbol }}{{ value.total_amount - value.coupon_discount }}</td>
                            <td>
    ...
    export default {
       ...
       methods : {
        ...
        getOrder(page = 1){
         ...
         axios.get(base_url+'admin/order-list?page='+page+'&order_id='+this.order_id+'&status='+this.status+'&payment='+this.payment_status+'&city='+this.city.id)
              .then(response => {
