  ...
  <tr style="height:auto;float:left;">
    <td>
      <p style="width:240px;padding: 10px 20px;border-bottom: 2px solid #888888;margin-top: 20px;font-size: 1.3em;">Reset Your Password</p>
          ...
          <a href="{{ url('user/reset/').'?token='.$token }}" style="padding: 12px 30px;text-decoration:none;background-color: #dff0d8;border:1px solid #d4cccc;border-radius: 5px;font-size: 1.1em;">Click To Reset Password</a>

          <p style="margin: 20px 25px;font-size: 1.1em;">If that doesn't work, copy and paste the following link in your browser: <a href="{{  url('user/reset/').'?token='.$token }}" target="_blank">{{ $token }}</a></p>
